    ...
    <div class="content_container">
      <div class="buttons">
        <div class="header_buttons">
          <FractalButtons @fractal="showFractalComponent" @plasma="showPlasmaComponent"></FractalButtons>
          <ColorPalette />
      ...
      <RenderContainer>
        <FractalGenerator v-if="showFractal" />
